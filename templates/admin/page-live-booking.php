...
<div class="main_live_container_div">
        	<div class="form_container form-style-3" >
            	<fieldset><legend>Book a Room</legend>
					...
					<label for="selector_of_field" ><span>Booking for </span><span class="required">*</span>
						<select name="selector_of_field" class="select-field" onchange="ghob_field_selector(this.value)">
							<option value="0">-- Select Type of Booking --</option>
							<option value="1">Beds</option>
							<option value="2">Rooms</option>
						</select>
					</label>
                    <label for="number_of_beds" id="field_number_of_beds"><span>Number of Beds</span><span class="required">*</span>
					...
					<label for="number_of_rooms" id="field_number_of_rooms"><span>Number of Rooms</span><span class="required">*</span>
		...
		<div class="form_container form-style-3" id="display_room_booked_error" >
			<fieldset><legend>Rooms/Beds Booking Error !!</legend>
				<label for="guest_name"><span>Room/Beds Booking has been interupped due to some server issues. Please Submit your form again or modify search</span>
				</label>
			</fieldset>
		</div>
		<div class="form_container form-style-3" id="display_room_booked" >
			<fieldset><legend>Rooms/Beds Booked !!</legend>
				<label for="guest_name"><span>Room/Beds Booked Successfully !! View the Booking in Bookings tab</span>
				</label>
			</fieldset>
		</div>
